<template>
  ...
  <div class="goods-base-info" v-if="Object.keys(goodsBaseInfo).length != 0">
    ...
    <div class="info-other">
      ...
      <span>
        <img :src="goodsBaseInfo.services[2].icon" alt="" />
        {{ goodsBaseInfo.services[2].name }}
      </span>
    </div>
    <!-- <div class="info-service">
      <span
        class="info-service-item"
        v-for="index in goodsBaseInfo.services.length - 1"
      >
        <img
          v-if="goodsBaseInfo.services[index - 1].icon"
          :src="goodsBaseInfo.services[index - 1].icon"
        />
...
export default {
  ...
  created() {
    // console.log(this.goodsBaseInfo.services.length);
  },
};
</script>
